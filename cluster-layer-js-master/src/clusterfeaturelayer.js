...
//    FeatureLayer,
    ...
    return declare([GraphicsLayer], {
        ...
        getPixelDistanceFromCenter: function (centerGeom) {
            var distance = this._flareDistanceFromCenter || 20;  //pixel distance from center
        ...
        _onClusterClick: function (e) {
            ...
            if (attr && attr.clusterCount) {
                ...
                console.log("_onClusterClick", source);
                ...
                var cSize = graphic.attributes.clusterCount;
                ...
                if (cSize > 1 && cSize <= 1000) {  //cSize > 1 may not be needed
                    //takes the number of points (flares) for the cluster
                    var numPoints = graphic.attributes.clusterCount;
                    ...
                    for (var i = 0; i < numPoints; i++) {
                        ...
                        // ptGraphic = new esri.Graphic(pt, this.symbolBank.single, dojo.mixin(graphic.attributes[i], { baseGraphic: graphic }), this._singleTemplate);
                        ptGraphic = new esri.Graphic(pt, this._singleSym, dojo.mixin(source[i].attributes, { baseGraphic: graphic }), this._singleTemplate);
